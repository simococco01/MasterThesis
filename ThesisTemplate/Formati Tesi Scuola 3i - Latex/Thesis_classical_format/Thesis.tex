...
\puttitle{
	...
	name=Simone Cocchi, % Author Name and Surname
	course=Nuclear Engineering - Ingegneria Nucleare, % Study Programme (in Italian)
	ID  = 11015557,  % Student ID number (numero di matricola)
	advisor= Prof. David Dellasega, % Supervisor name
	coadvisor={Alexander von Müller}, % Co-Supervisor name, remove this line if there is none
